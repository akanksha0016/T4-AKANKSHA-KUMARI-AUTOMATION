...
driver.implicitly_wait(30)  # Implicit wait
...
driver.find_element(By.XPATH,"//input[@type='text' and @placeholder='Enter generator name']").send_keys("Akanksha16")
...
driver.find_element(By.XPATH,
                    "//input[@id='serviceAddress-street' and @type='text']").send_keys("Saltlake,sector V")
...
time.sleep(2)
driver.find_element(By.XPATH,
                    "//input[@placeholder='Email Address' and @id='serviceAddress-email']").send_keys(
    "akanksha@gmail.com")

# Enter Phone Number
time.sleep(2)
driver.find_element(By.XPATH,
                    "//input[@id='serviceAddress-phone' and @placeholder='(123) 456-7890']").send_keys(
    "7033112754")
